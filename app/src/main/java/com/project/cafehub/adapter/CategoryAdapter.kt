...
class CategoryAdapter(val categoryList: ArrayList<String>, val categoryClickInterface: CategoryOnClickInterface)
    ...
    override fun onBindViewHolder(holder: CategoryHolder, position: Int) {
        holder.binding.btnItemCategory.text = categoryList.get(position)
